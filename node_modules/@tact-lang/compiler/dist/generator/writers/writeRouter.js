        ...
        if (fbStmt.kind === "statement_expression" &&
            ...
            if (typeof throwArg !== "undefined") {
                ...
                if (constEvalResult.kind !== "number") {
                    (0, errors_1.throwInternalCompilerError)(`"throw" can only have a number as an argument, but it has throws ${(0, ast_printer_1.prettyPrint)(constEvalResult)}`, throwArg.loc);
                }
                return {
