...
function writeStdlib(ctx) {
    ...
    ctx.fun("__tact_dump", () => {
        ctx.signature(`forall X -> () __tact_dump(X value, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.asm("", "STRDUMP DROP STRDUMP DROP s0 DUMP DROP");
    });
    ctx.fun("__tact_dump_str", () => {
        ctx.signature(`() __tact_dump_str(slice value, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.asm("", "STRDUMP DROP STRDUMP DROP STRDUMP DROP");
    });
    ctx.fun("__tact_dump_bool", () => {
        ctx.signature(`() __tact_dump_bool(int value, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
                if (null?(value)) {
                    ...
                    ${ctx.used("__tact_dump_str")}("true", debug_print_1, debug_print_2);
                } else {
                    ${ctx.used("__tact_dump_str")}("false", debug_print_1, debug_print_2);
                }
            `);
        });
    });
    ctx.fun("__tact_dump_string", () => {
        ctx.signature(`() __tact_dump_string(slice str, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dump_int", () => {
        ctx.signature(`() __tact_dump_int(int number, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
                if (null?(number)) {
                    ...
                    ${ctx.used("__tact_dump_str")}(${ctx.used(ops_1.ops.extension("Int", "toString"))}(number), debug_print_1, debug_print_2);
                }
            `);
        });
    });
    ...
    ctx.fun("__tact_dump_address", () => {
        ctx.signature(`() __tact_dump_address(slice address, slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
                if (null?(address)) {
                    ...
                    ${ctx.used("__tact_dump_str")}(${ctx.used("__tact_address_to_user_friendly")}(address), debug_print_1, debug_print_2);
                }
            `);
        });
    });
    ctx.fun("__tact_dump_stack", () => {
        ctx.signature(`() __tact_dump_stack(slice debug_print_1, slice debug_print_2)`);
        ctx.flag("impure");
        ctx.context("stdlib");
