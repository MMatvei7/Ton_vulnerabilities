import { Address, beginCell, Cell, Contract, contractAddress, ContractProvider, Message, Sender, SendMode } from "@ton/core";
...
export class MainContract implements Contract {
  ...
  async sendDeposit(provider: ContractProvider, sender: Sender, value: bigint) : Promise<MyMessage> {
    const msg_body = beginCell()
    ...
    await provider.internal(sender, args_msg);
    return args_msg;
  }
